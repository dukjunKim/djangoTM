...
class TmabTbKt10(models.Model):
    ...
    reg_no = models.CharField(max_length=-1, blank=True, null=True)
    reg_date = models.CharField(max_length=-1, blank=True, null=True)
    tm_name_kor = models.CharField(max_length=-1, blank=True, null=True)
    tm_name_eng = models.CharField(max_length=-1, blank=True, null=True)
    final_decision_code = models.CharField(max_length=-1, blank=True, null=True)
    final_decision_code_name = models.CharField(max_length=-1, blank=True, null=True)
    final_decision_date = models.CharField(max_length=-1, blank=True, null=True)
    tm_category_code = models.CharField(max_length=-1, blank=True, null=True)
    tm_category_code_name = models.CharField(max_length=-1, blank=True, null=True)
    tm_class_code = models.CharField(max_length=-1, blank=True, null=True)
    tm_class_code_name = models.CharField(max_length=-1, blank=True, null=True)
    goods_class_ver = models.CharField(max_length=-1, blank=True, null=True)
    has_tm_image = models.CharField(max_length=-1, blank=True, null=True)
    has_pub = models.CharField(max_length=-1, blank=True, null=True)
    has_amend_pub = models.CharField(max_length=-1, blank=True, null=True)
    has_ori_appl = models.CharField(max_length=-1, blank=True, null=True)
    has_trial = models.CharField(max_length=-1, blank=True, null=True)
    has_priority = models.CharField(max_length=-1, blank=True, null=True)
    intl_reg_no = models.CharField(max_length=-1, blank=True, null=True)
    intl_reg_no_date = models.CharField(max_length=-1, blank=True, null=True)
    subsequent_designation_date = models.CharField(max_length=-1, blank=True, null=True)
    final_retro_code = models.CharField(max_length=-1, blank=True, null=True)
    final_retro_code_name = models.CharField(max_length=-1, blank=True, null=True)
    final_retro_date = models.CharField(max_length=-1, blank=True, null=True)
    tm_name_date = models.CharField(max_length=-1, blank=True, null=True)
    exp_date = models.CharField(max_length=-1, blank=True, null=True)
    ...
    legal_status = models.CharField(max_length=-1, blank=True, null=True)
    is_service_start = models.CharField(max_length=-1, blank=True, null=True)
    pub_reg_no = models.CharField(max_length=-1, blank=True, null=True)
    pub_reg_date = models.CharField(max_length=-1, blank=True, null=True)
    is_full_pub_reg = models.CharField(max_length=-1, blank=True, null=True)
...
class TmabTbKt13(models.Model):
    ...
    priority_country_code_name = models.CharField(max_length=-1, blank=True, null=True)
    init_update_date = models.CharField(max_length=-1, blank=True, null=True)
    final_modified_date = models.CharField(max_length=-1, blank=True, null=True)
...
class TmpdIntHistoryKt(models.Model):
    ...
    process = models.CharField(max_length=-1, blank=True, null=True)
    trial_no = models.CharField(max_length=-1, blank=True, null=True)
    regist_no = models.CharField(max_length=-1, blank=True, null=True)
